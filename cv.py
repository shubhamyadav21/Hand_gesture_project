# -*- coding: utf-8 -*-
"""
Created on Fri Apr  8 14:38:50 2022

"""

#-----------------------------------------------------------------------------
#Step - 1  -Import Libraries and capture camera
#Step - 2  -Convert frames Into hsv (hue saturated value)
...
import numpy as np 
import math
import pyautogui as p # with the help of this library we can controll our keyboard with our gesture
import time as t



#Read Camera
cap = cv2.VideoCapture(0,cv2.CAP_DSHOW) # 0 for your laptop camera we can pass 1 for any additional camera or external camera
